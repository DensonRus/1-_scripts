...
Если ЭтоНовыйПользователь Тогда	
	...
	//ПутьКХранилищу = "C:\\1c-Repository\\ut-ds-develop";
		Попытка
			Конфигуратор.ДобавитьПользователяВХранилище(ПутьКХранилищу,"dbelmach","dbelmach","ipoymanova","ipoymanova",ПраваПользователяХранилища.ПравоИзмененияВерсий);
			//Конфигуратор.КопироватьПользователейИзХранилища("D:\\1c-Repository\\ut-ocm-deploy","dbelmach","dbelmach",ПутьКХранилищу,"dbelmach","dbelmach");
